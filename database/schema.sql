...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 08, 2019 at 07:21 PM
...
id`,
`fullName
`, `email`, `password`, `profilePicture`, `bannerPicture`, `description`, `residentCounty_id`, `HomeTown_id`, `id_Roles`, `id_Personalities`) VALUES
(1, NULL, 'mohbah026@gmail.com', 'asdasdasd', NULL, NULL, NULL, 'AGO', 2760, NULL, NULL);
...
--
-- Table structure for table `BookedResident`
--

CREATE TABLE `BookedResident`
(
  `id` int
(11) NOT NULL,
  `name` varchar
...
(11) NOT NULL,
  `Name` char
(35) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `CountryCode` char
(3) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `District` char
(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Population` int
...
(3) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Name` char
(52) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Continent` enum
('Asia','Europe','North America','Africa','Oceania','Antarctica','South America') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Asia',
  `Region` char
(26) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `SurfaceArea` float
...
(10,2) DEFAULT NULL,
  `LocalName` char
(45) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `GovernmentForm` char
(45) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `HeadOfState` char
(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Capital` int
(11) DEFAULT NULL,
  `Code2` char
(2) COLLATE utf8_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
Code`,
`Name
`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES
...
('KOR', 'South Korea', 'Asia', 'Eastern Asia', 99434.00, 1948, 46844000, 74.4, 320749.00, 442544.00, 'Taehan Min’guk
(Namhan)', 'Republic', 'Kim Dae-jung', 2331, 'KR'),
('KWT', 'Kuwait', 'Asia', 'Middle East', 17818.00, 1961, 1972000, 76.1, 27037.00, 30373.00, 'Al-Kuwayt', 'Constitutional Monarchy
(Emirate)', 'Jabir al-Ahmad al-Jabir al-Sabah', 2429, 'KW'),
...
('OMN', 'Oman', 'Asia', 'Middle East', 309500.00, 1951, 2542000, 71.8, 16904.00, 16153.00, '´Uman', 'Monarchy
(Sultanate)', 'Qabus ibn Sa´id', 2821, 'OM'),
...
('PRK', 'North Korea', 'Asia', 'Eastern Asia', 120538.00, 1948, 24039000, 70.7, 5332.00, NULL, 'Choson Minjujuui In´min Konghwaguk
...
('PSE', 'Palestine', 'Asia', 'Middle East', 6257.00, NULL, 3101000, 71.4, 4173.00, NULL, 'Filastin', 'Autonomous Area', 'Yasser
(Yasir) Arafat', 4074, 'PS'),
...
(3) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Language` char
(30) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `IsOfficial` enum
('T','F') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'F',
  `Percentage` float
...
--
-- Table structure for table `FavoritePlaces`
--
...
--
-- Table structure for table `FavoritePlacesOptions`
--

CREATE TABLE `FavoritePlacesOptions`
(
  `id` int
(11) NOT NULL,
  `id_FavoritePlaces` int
(11) DEFAULT NULL,
  `id_Account` int
(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Table structure for table `LocalTransitMode`
--

CREATE TABLE `LocalTransitMode`
(
  `id` int
(11) NOT NULL,
  `type` varchar
...
--
-- Dumping data for table `LocalTransitMode`
--

INSERT INTO `LocalTransitMode` (`
id`,
`type
`) VALUES
(1, 'Rent a Car'),
...
--
-- Table structure for table `LocalTransitOptions`
--

CREATE TABLE `LocalTransitOptions`
(
  `id` int
(11) NOT NULL,
  `id_Account` int
(11) DEFAULT NULL,
  `id_LocalTransitMode` int
(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Table structure for table `LocalTransportations`
--

CREATE TABLE `LocalTransportations`
(
  `id` int
(11) NOT NULL,
  `destination` varchar
...
`id
`) VALUES
('Soul Searcher & Clarity Seeker', 1),
('Imaginative', 2),
('People Focused', 3),
('Out of Comfort Zone & Adaptability', 4),
('Open Minded Adventurous', 5),
('Cultural & Absorbptive', 6),
('Sensual', 7),
('Perspective Seeking', 8);

-- --------------------------------------------------------

--
-- Table structure for table `PreferredActivity`
--

CREATE TABLE `PreferredActivity`
(
  `id` int
(11) NOT NULL,
  `name` varchar
...
--
-- Dumping data for table `PreferredActivity`
--

INSERT INTO `PreferredActivity` (`
id`,
`name
`) VALUES
(1, 'Family'),
...
(6, 'Adrenaline'),
(7, 'Romantic'),
(8, 'Full Day/ Half Day Tours');

-- --------------------------------------------------------

--
-- Table structure for table `PreferredActivityOptions`
--

CREATE TABLE `PreferredActivityOptions`
(
  `id` int
(11) NOT NULL,
  `id_Account` int
...
--
-- Table structure for table `PreferredDish`
--

CREATE TABLE `PreferredDish`
(
  `id` int
(11) NOT NULL,
  `name` varchar
...
--
-- Table structure for table `PreferredDishOptions`
--

CREATE TABLE `PreferredDishOptions`
(
  `id` int
(11) NOT NULL,
  `id_Account` int
(11) DEFAULT NULL,
  `id_PreferredDish` int
(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Table structure for table `StayMode`
--

CREATE TABLE `StayMode`
(
  `id` int
(11) NOT NULL,
  `mode` varchar
...
--
-- Dumping data for table `StayMode`
--

INSERT INTO `StayMode` (`
id`,
`mode
`) VALUES
(1, 'As Suggested by Content Creator'),
(2, 'Near Public Transits'),
(3, 'Highly Rated Hotels'),
(4, 'Cheap and Affordable Hotels'),
(5, 'Luxury Hotels'),
(6, 'Near City Center');
...
--
-- Table structure for table `StayOptions`
--
...
--
-- Table structure for table `TravailedPlaces`
--

CREATE TABLE `TravailedPlaces`
(
  `id` int
(11) NOT NULL,
  `name` varchar
...
--
-- Table structure for table `TravailedPlacesOptions`
--

CREATE TABLE `TravailedPlacesOptions`
(
  `id` int
(11) NOT NULL,
  `id_TravailedPlaces` int
(11) NOT NULL,
  `id_Account` int
(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Table structure for table `TravailMode`
--

CREATE TABLE `TravailMode`
(
  `id` int
(11) NOT NULL,
  `mode` varchar
...
--
-- Dumping data for table `TravailMode`
--

INSERT INTO `TravailMode` (`
id`,
`mode
`) VALUES
(1, 'Group Travel'),
...
--
-- Table structure for table `TravailModeOptions`
--

CREATE TABLE `TravailModeOptions`
(
  `id` int
(11) NOT NULL,
  `id_Account` int
...
--
-- Table structure for table `TypeOfTripOptions`
--

CREATE TABLE `TypeOfTripOptions`
(
  `id` int
(11) NOT NULL,
  `id_TypeOfTrip` int
...
ADD KEY `id_Days`
(`id_Days`),
ADD KEY `id_PreferredActivity`
(`id_PreferredActivity`);
...
--
-- Indexes for table `BookedResident`
--
ALTER TABLE `BookedResident`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_BookTrip`
(`id_BookTrip`),
...
--
-- Indexes for table `FavoritePlacesOptions`
--
ALTER TABLE `FavoritePlacesOptions`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_FavoritePlaces`
(`id_FavoritePlaces`),
ADD KEY `id_Account`
(`id_Account`);

--
-- Indexes for table `FlightSegment`
--
ALTER TABLE `FlightSegment`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_Bookedflights`
(`id_Bookedflights`);
...
--
-- Indexes for table `LocalTransitMode`
--
ALTER TABLE `LocalTransitMode`
ADD PRIMARY KEY
(`id`);

--
-- Indexes for table `LocalTransitOptions`
--
ALTER TABLE `LocalTransitOptions`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_Account`
(`id_Account`),
ADD KEY `id_LocalTransitMode`
(`id_LocalTransitMode`);

--
-- Indexes for table `LocalTransportations`
--
ALTER TABLE `LocalTransportations`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_Days`
(`id_Days`),
...
--
-- Indexes for table `PreferredActivity`
--
ALTER TABLE `PreferredActivity`
ADD PRIMARY KEY
(`id`);

--
-- Indexes for table `PreferredActivityOptions`
--
ALTER TABLE `PreferredActivityOptions`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_Account`
(`id_Account`),
...
--
-- Indexes for table `PreferredDish`
--
ALTER TABLE `PreferredDish`
ADD PRIMARY KEY
(`id`);

--
-- Indexes for table `PreferredDishOptions`
--
ALTER TABLE `PreferredDishOptions`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_Account`
(`id_Account`),
ADD KEY `id_PreferredDish`
(`id_PreferredDish`);
...
--
-- Indexes for table `StayMode`
--
ALTER TABLE `StayMode`
ADD PRIMARY KEY
(`id`);

--
-- Indexes for table `StayOptions`
--
ALTER TABLE `StayOptions`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_Account`
(`id_Account`),
...
--
-- Indexes for table `TravailedPlaces`
--
ALTER TABLE `TravailedPlaces`
ADD PRIMARY KEY
(`id`);

--
-- Indexes for table `TravailedPlacesOptions`
--
ALTER TABLE `TravailedPlacesOptions`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_TravailedPlaces`
(`id_TravailedPlaces`),
ADD KEY `id_Account`
(`id_Account`);

--
-- Indexes for table `TravailMode`
--
ALTER TABLE `TravailMode`
ADD PRIMARY KEY
(`id`);

--
-- Indexes for table `TravailModeOptions`
--
ALTER TABLE `TravailModeOptions`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_Account`
(`id_Account`),
ADD KEY `id_TravailMode`
(`id_TravailMode`);
...
ADD KEY `id_Account`
(`id_Account`),
ADD KEY `id_TypeOfTrip`
(`id_TypeOfTrip`);

--
-- Indexes for table `TypeOfTrip`
--
ALTER TABLE `TypeOfTrip`
ADD PRIMARY KEY
(`id`);

--
-- Indexes for table `TypeOfTripOptions`
--
ALTER TABLE `TypeOfTripOptions`
ADD PRIMARY KEY
(`id`),
ADD KEY `id_TypeOfTrip`
(`id_TypeOfTrip`),
...
--
-- AUTO_INCREMENT for table `BookedResident`
--
ALTER TABLE `BookedResident`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `City`
  MODIFY `ID` int
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4081;
...
--
-- AUTO_INCREMENT for table `FavoritePlacesOptions`
--
ALTER TABLE `FavoritePlacesOptions`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `FlightSegment`
--
ALTER TABLE `FlightSegment`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `LocalTransitMode`
--
ALTER TABLE `LocalTransitMode`
  MODIFY `id` int
...
--
-- AUTO_INCREMENT for table `LocalTransitOptions`
--
ALTER TABLE `LocalTransitOptions`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `LocalTransportations`
--
ALTER TABLE `LocalTransportations`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `PreferredActivity`
--
ALTER TABLE `PreferredActivity`
  MODIFY `id` int
...
--
-- AUTO_INCREMENT for table `PreferredActivityOptions`
--
ALTER TABLE `PreferredActivityOptions`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `PreferredDish`
--
ALTER TABLE `PreferredDish`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `PreferredDishOptions`
--
ALTER TABLE `PreferredDishOptions`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `StayMode`
--
ALTER TABLE `StayMode`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `StayOptions`
--
ALTER TABLE `StayOptions`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `TravailedPlaces`
--
ALTER TABLE `TravailedPlaces`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `TravailedPlacesOptions`
--
ALTER TABLE `TravailedPlacesOptions`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `TravailMode`
--
ALTER TABLE `TravailMode`
  MODIFY `id` int
...
--
-- AUTO_INCREMENT for table `TravailModeOptions`
--
ALTER TABLE `TravailModeOptions`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `TypeOfTrip`
--
ALTER TABLE `TypeOfTrip`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `TypeOfTripOptions`
--
ALTER TABLE `TypeOfTripOptions`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `Account`
ADD CONSTRAINT `Account_ibfk_3` FOREIGN KEY
(`id_Roles`) REFERENCES `Roles`
(`id`),
ADD CONSTRAINT `Account_ibfk_4` FOREIGN KEY
(`id_Personalities`) REFERENCES `Personalities`
(`id`),
ADD CONSTRAINT `city_fk` FOREIGN KEY
(`HomeTown_id`) REFERENCES `City`
(`ID`) ON
DELETE RESTRICT ON
UPDATE RESTRICT,
ADD CONSTRAINT `country_fk` FOREIGN KEY
(`residentCounty_id`) REFERENCES `Country`
(`Code`) ON
DELETE RESTRICT ON
UPDATE RESTRICT;
...
--
ALTER TABLE `Activities`
ADD CONSTRAINT `Activities_ibfk_1` FOREIGN KEY
(`id_Days`) REFERENCES `Days`
(`id`),
ADD CONSTRAINT `Activities_ibfk_2` FOREIGN KEY
(`id_PreferredActivity`) REFERENCES `PreferredActivity`
(`id`);
...
--
ALTER TABLE `Bookedflights`
ADD CONSTRAINT `Bookedflights_ibfk_1` FOREIGN KEY
(`id_BookTrip`) REFERENCES `BookTrip`
(`id`);

--
-- Constraints for table `BookedResident`
--
ALTER TABLE `BookedResident`
ADD CONSTRAINT `BookedResident_ibfk_1` FOREIGN KEY
(`id_BookTrip`) REFERENCES `BookTrip`
(`id`),
ADD CONSTRAINT `BookedResident_ibfk_2` FOREIGN KEY
(`id_StayMode`) REFERENCES `StayMode`
(`id`);
...
--
ALTER TABLE `BookTrip`
ADD CONSTRAINT `BookTrip_ibfk_1` FOREIGN KEY
(`id_Account`) REFERENCES `Account`
(`id`),
ADD CONSTRAINT `BookTrip_ibfk_2` FOREIGN KEY
(`id_Trips`) REFERENCES `Trips`
(`id`);
...
--
ALTER TABLE `City`
ADD CONSTRAINT `city_ibfk_1` FOREIGN KEY
...
--
ALTER TABLE `CountryLanguage`
ADD CONSTRAINT `countryLanguage_ibfk_1` FOREIGN KEY
(`CountryCode`) REFERENCES `Country`
(`Code`);
...
--
ALTER TABLE `Days`
ADD CONSTRAINT `Days_ibfk_1` FOREIGN KEY
(`id_Trip`) REFERENCES `Trips`
(`id`);

--
-- Constraints for table `FavoritePlacesOptions`
--
ALTER TABLE `FavoritePlacesOptions`
ADD CONSTRAINT `FavoritePlacesOptions_ibfk_1` FOREIGN KEY
(`id_FavoritePlaces`) REFERENCES `FavoritePlaces`
(`id`),
ADD CONSTRAINT `FavoritePlacesOptions_ibfk_2` FOREIGN KEY
(`id_Account`) REFERENCES `Account`
(`id`);

--
-- Constraints for table `FlightSegment`
--
ALTER TABLE `FlightSegment`
ADD CONSTRAINT `FlightSegment_ibfk_1` FOREIGN KEY
(`id_Bookedflights`) REFERENCES `Bookedflights`
(`id`);
...
--
-- Constraints for table `LocalTransitOptions`
--
ALTER TABLE `LocalTransitOptions`
ADD CONSTRAINT `LocalTransitOptions_ibfk_1` FOREIGN KEY
(`id_Account`) REFERENCES `Account`
(`id`),
ADD CONSTRAINT `LocalTransitOptions_ibfk_2` FOREIGN KEY
(`id_LocalTransitMode`) REFERENCES `LocalTransitMode`
(`id`);

--
-- Constraints for table `LocalTransportations`
--
ALTER TABLE `LocalTransportations`
ADD CONSTRAINT `LocalTransportations_ibfk_1` FOREIGN KEY
(`id_Days`) REFERENCES `Days`
(`id`),
ADD CONSTRAINT `LocalTransportations_ibfk_2` FOREIGN KEY
(`id_LocalTransitMode`) REFERENCES `LocalTransitMode`
(`id`);

--
-- Constraints for table `PreferredActivityOptions`
--
ALTER TABLE `PreferredActivityOptions`
ADD CONSTRAINT `PreferredActivityOptions_ibfk_1` FOREIGN KEY
(`id_Account`) REFERENCES `Account`
(`id`),
ADD CONSTRAINT `PreferredActivityOptions_ibfk_2` FOREIGN KEY
(`id_PreferredActivity`) REFERENCES `PreferredActivity`
(`id`);

--
-- Constraints for table `PreferredDishOptions`
--
ALTER TABLE `PreferredDishOptions`
ADD CONSTRAINT `PreferredDishOptions_ibfk_1` FOREIGN KEY
(`id_Account`) REFERENCES `Account`
(`id`),
ADD CONSTRAINT `PreferredDishOptions_ibfk_2` FOREIGN KEY
(`id_PreferredDish`) REFERENCES `PreferredDish`
(`id`);
...
--
ALTER TABLE `Residents`
ADD CONSTRAINT `Residents_ibfk_1` FOREIGN KEY
(`id_Days`) REFERENCES `Days`
(`id`),
ADD CONSTRAINT `Residents_ibfk_2` FOREIGN KEY
(`id_StayMode`) REFERENCES `StayMode`
(`id`);

--
-- Constraints for table `StayOptions`
--
ALTER TABLE `StayOptions`
ADD CONSTRAINT `StayOptions_ibfk_1` FOREIGN KEY
(`id_Account`) REFERENCES `Account`
(`id`),
ADD CONSTRAINT `StayOptions_ibfk_2` FOREIGN KEY
(`id_StayMode`) REFERENCES `StayMode`
(`id`);

--
-- Constraints for table `TravailedPlacesOptions`
--
ALTER TABLE `TravailedPlacesOptions`
ADD CONSTRAINT `TravailedPlacesOptions_ibfk_1` FOREIGN KEY
(`id_TravailedPlaces`) REFERENCES `TravailedPlaces`
(`id`),
ADD CONSTRAINT `TravailedPlacesOptions_ibfk_2` FOREIGN KEY
(`id_Account`) REFERENCES `Account`
(`id`);

--
-- Constraints for table `TravailModeOptions`
--
ALTER TABLE `TravailModeOptions`
ADD CONSTRAINT `TravailModeOptions_ibfk_1` FOREIGN KEY
(`id_Account`) REFERENCES `Account`
(`id`),
ADD CONSTRAINT `TravailModeOptions_ibfk_2` FOREIGN KEY
(`id_TravailMode`) REFERENCES `TravailMode`
(`id`);
...
--
ALTER TABLE `Trips`
ADD CONSTRAINT `Trips_ibfk_1` FOREIGN KEY
(`id_Account`) REFERENCES `Account`
(`id`),
ADD CONSTRAINT `Trips_ibfk_2` FOREIGN KEY
(`id_TypeOfTrip`) REFERENCES `TypeOfTrip`
(`id`);

--
-- Constraints for table `TypeOfTripOptions`
--
ALTER TABLE `TypeOfTripOptions`
ADD CONSTRAINT `TypeOfTripOptions_ibfk_1` FOREIGN KEY
(`id_TypeOfTrip`) REFERENCES `TypeOfTrip`
(`id`),
ADD CONSTRAINT `TypeOfTripOptions_ibfk_2` FOREIGN KEY
(`id_Account`) REFERENCES `Account`
(`id`);
COMMIT;
